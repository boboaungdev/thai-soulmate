...
-- CreateEnum
CREATE TYPE "ApplicationFormStatus" AS ENUM ('RECEIVED', 'PENDING', 'COMPLETED', 'CLOSED');
...
-- CreateEnum
CREATE TYPE "TrackingNoteType" AS ENUM ('INITIAL_CONNECT', 'BOTH_PROFILES_SENT', 'MALE_PROFILE_SENT_TO_FEMALE', 'FEMALE_PROFILE_SENT_TO_MALE', 'FEMALE_REVIEW', 'FEMALE_THINKING', 'FEMALE_REJECTED', 'FEMALE_ACCEPTED', 'MALE_REVIEW', 'MALE_THINKING', 'MALE_REJECTED', 'MALE_ACCEPTED', 'BOTH_PROFILES_ACCEPTED', 'FIRST_GOOGLE_MEET', 'SECOND_GOOGLE_MEET', 'THIRD_GOOGLE_MEET', 'FIRST_FOLLOW_UP', 'SECOND_FOLLOW_UP', 'THIRD_FOLLOW_UP', 'FINAL_MATCH', 'MATCHED', 'CLOSED', 'MANUAL', 'CALL_LOG', 'FEEDBACK');
...
CREATE TABLE "RegisterInterest" (
    ...
    "phone" TEXT NOT NULL,
    "preferredContactDate" TIMESTAMP(3),
...
CREATE TABLE "Tracking" (
    ...
    "completedStatuses" "TrackingStatus"[] DEFAULT ARRAY['INITIAL_CONNECT']::"TrackingStatus"[],
