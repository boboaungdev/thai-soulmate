...
function BrandName({ className = "" }: { className?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient
          id="whatsapp-vertical-brand-gradient"
          x1="0"
          y1="0"
          x2="1"
          y2="0"
      ...
      <text
        x="90"
        y="22"
        fill="url(#whatsapp-vertical-brand-gradient)"
...
export default function WhatsAppQrPrintPage() {
  return (
    <>
      <PrintTrigger />
      ...
      <style jsx global>{`
        ...
        *::after {
        ...
        #printable-area.whatsapp-qr-document {
          display: flex;
      ...
      <main id="printable-area" className="whatsapp-qr-document">
        <section
          className="whatsapp-qr-card shadow-2xl"
          aria-label="WhatsApp QR code card"
          style={{
            background:
        ...
        >
          ...
          <div className="relative z-10 flex h-full flex-col items-center px-[5mm] pt-[4.5mm] pb-[4mm]">
            ...
            <div className="mt-[2mm] flex flex-col items-center">
              ...
              <p className="mt-[1.8mm] max-w-[39mm] text-center font-sans text-[1.8mm] leading-none font-semibold text-white/90">
