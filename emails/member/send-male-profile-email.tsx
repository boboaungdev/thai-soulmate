  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={paragraph}>
          Please let us know your decision within <b>24 hours</b> by clicking
        ...
        <Text style={paragraph}>
          Once we receive your decision, we will proceed with the next steps. If
          you accept, we will notify him for the introduction.
        </Text>
